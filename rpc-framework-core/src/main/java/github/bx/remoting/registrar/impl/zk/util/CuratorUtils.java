package github.bx.remoting.registrar.impl.zk.util;
 ...
 *
 * 这里把 getChildrenNodes 和 createPersistentNode 2 个方法获取 zkClient 的逻辑改为封装在方法内，而不是
 * 由外部传入
 */
@Slf4j
public final class CuratorUtils {
    ...
    /*
     * 把获取 zookeeper client 的逻辑改为封装在工具类方法中
     * */
